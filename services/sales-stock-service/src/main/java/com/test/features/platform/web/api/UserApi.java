...
import com.test.features.platform.data.model.experience.user.CreateUserRequest;
import com.test.features.platform.data.model.experience.user.UpdateUserRequest;
import com.test.features.platform.data.model.experience.user.User;
import com.test.features.platform.web.service.UserService;
 ...
 * persistence models of type {@link com.test.features.platform.data.model.persistence.UserEntity}.
 *
 * @author Admin
 */
@Slf4j
...
public class UserApi extends AbstractApi {
     ...
     * com.test.features.platform.data.model.persistence.UserEntity} into the system.
     *
     * @param payload Payload containing the details required to create an instance of type {@link
     *     com.test.features.platform.data.model.persistence.UserEntity}.
     ...
     * com.test.features.platform.data.model.persistence.UserEntity} in the system.
     *
     ...
     * com.test.features.platform.data.model.persistence.UserEntity} in the system in a paginated
     * manner.
     *
     ...
     *     {@link com.test.features.platform.data.model.persistence.UserEntity} that was deleted
     *     from the system.
     */
    @Operation(
            method = "deleteUser",
