...
import com.test.features.platform.data.model.experience.role.CreateRoleRequest;
import com.test.features.platform.data.model.experience.role.Role;
import com.test.features.platform.data.model.experience.role.UpdateRoleRequest;
import com.test.features.platform.web.service.RoleService;
 ...
 * persistence models of type {@link com.test.features.platform.data.model.persistence.RoleEntity}.
 *
 * @author Admin
 */
@Slf4j
...
public class RoleApi extends AbstractApi {
     ...
     * com.test.features.platform.data.model.persistence.RoleEntity} into the system.
     *
     * @param payload Payload containing the details required to create an instance of type {@link
     *     com.test.features.platform.data.model.persistence.RoleEntity}.
     ...
     * com.test.features.platform.data.model.persistence.RoleEntity} in the system.
     *
     ...
     * com.test.features.platform.data.model.persistence.RoleEntity} in the system in a paginated
     * manner.
     *
     ...
     *     {@link com.test.features.platform.data.model.persistence.RoleEntity} that was deleted
     *     from the system.
     */
    @Operation(
            method = "deleteRole",
