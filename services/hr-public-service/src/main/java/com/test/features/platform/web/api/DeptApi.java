...
import com.test.features.platform.data.model.experience.dept.CreateDeptRequest;
import com.test.features.platform.data.model.experience.dept.Dept;
import com.test.features.platform.data.model.experience.dept.UpdateDeptRequest;
import com.test.features.platform.web.service.DeptService;
 ...
 * persistence models of type {@link com.test.features.platform.data.model.persistence.DeptEntity}.
 *
 * @author Admin
 */
@Slf4j
@RestController
@RequestMapping(DeptApi.rootEndPoint)
public class DeptApi extends AbstractApi {
     ...
     * com.test.features.platform.data.model.persistence.DeptEntity} into the system.
     *
     * @param payload Payload containing the details required to create an instance of type {@link
     *     com.test.features.platform.data.model.persistence.DeptEntity}.
     ...
     * com.test.features.platform.data.model.persistence.DeptEntity} in the system.
     *
     ...
     * com.test.features.platform.data.model.persistence.DeptEntity} in the system in a paginated
     * manner.
     *
     ...
     *     {@link com.test.features.platform.data.model.persistence.DeptEntity} that was deleted
     *     from the system.
     */
    @Operation(
            method = "deleteDept",
