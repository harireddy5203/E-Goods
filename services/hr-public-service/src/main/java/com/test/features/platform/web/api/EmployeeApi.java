...
import com.test.features.platform.web.service.EmployeeService;
 ...
 * com.test.features.platform.data.model.persistence.EmployeeEntity}.
 *
 * @author Admin
 */
@Slf4j
...
public class EmployeeApi extends AbstractApi {
     ...
     * com.test.features.platform.data.model.persistence.EmployeeEntity} into the system.
     *
     ...
     * com.test.features.platform.data.model.persistence.EmployeeEntity} in the system.
     *
     ...
     * com.test.features.platform.data.model.persistence.EmployeeEntity} in the system in a
     * paginated manner.
     *
     ...
     *     {@link com.test.features.platform.data.model.persistence.EmployeeEntity} that was deleted
     *     from the system.
     */
    @Operation(
